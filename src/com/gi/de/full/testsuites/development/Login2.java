 ...
 *
 */
public class Login2 extends BaseTestCase {

	@Test
	public void LoginScreen_ApplicationUrl1() {
	...
	@Test(enabled = false)
	public void loginScreen_ValidUser_OperationManager1() {
		ExtentTest logger = ExtentTestManager.getTest();
	...
	@Test(enabled = false)
	public void loginScreen_ValidUser_ProductionStaff1() {
		ExtentTest logger = ExtentTestManager.getTest();
