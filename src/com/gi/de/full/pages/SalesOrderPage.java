...
/**
 * @author neerajm <img src="./screenshots/SalesOrderPage.png" />
 */
public class SalesOrderPage extends BaseTestPage {
	...
	// header
	@FindBy(xpath = "//h1[text()='Sales Order']")
	public WebElement headerSalesOrder;
	...
	@FindBy(xpath = "//button[text()='Generate PO']")
	public WebElement buttonGeneratePO;
	...
	public void waitForPageToLoad() {
		if (super.isPageLoaded(driver))
			try {
				...
				WaitUtils.waitforElementToBeVisible(driver, headerSalesOrder);
